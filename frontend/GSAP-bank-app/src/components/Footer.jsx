...
function Footer() {
  ...
  return (
    <div data-scroll data-scroll-section data-scroll-speed=".3" className='w-full h-screen grid md:grid-cols-2 gap-20 md:gap-5 md:px-16 px-5 md:pt-20 pt-5 pb-10'>
        ...
        <h1 className='font-title md:text-[7.3vw] text-[10vw] text-zinc-900 font-extrabold md:leading-[7vw] leading-[10vw] uppercase'>eye- <br />
        opening</h1>
        ...
        <div className='md:w-full h-full flex flex-col justify-between'>
            <h1 className='font-title md:text-[7.3vw] text-[10vw] font-extrabold md:leading-[5vw] text-zinc-900 uppercase'>presentations</h1>
            <div className='w-full flex justify-between px-6 py-5 mb-24'>
                <div className='flex flex-col gap-14'>
                    {link.slice(0,3).map((elem, index)=>(
                        <div key={index} className='h-fit flex flex-col justify-between'>
                            <h2 className='mb-2 md:text-2xl font-semibold'>{elem.head}</h2>
                            <div>
                                {elem.sublink.map((item, index)=>(
                                    <p key={index} className='underline cursor-pointer md:text-xl'>{item}</p>
                                ))}
                            </div>
                        </div>
                    ))}
